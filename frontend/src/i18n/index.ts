  ...
  'zh-CN': {
    ...
    profiles: {
      ...
      latency: {
        ...
        checkedAt: '最后测试：{time}',
        officialIdleTooltip: '通过额度接口测试当前官方账号的响应延迟和可用性',
        apiIdleTooltip: '通过 GET /models 测试当前 API Key 的响应延迟和可用性',
  ...
  'en-US': {
    ...
    profiles: {
      ...
      latency: {
        ...
        officialIdleTooltip: 'Test response latency and availability for the current official account through the rate-limit endpoint.',
        apiIdleTooltip: 'Test response latency and availability for the current API key through GET /models.',
